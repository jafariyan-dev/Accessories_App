...
import com.example.accessories_app.helper.ManagmentCart
...
class CartAdapter (private val listItemSelected: ArrayList<Product>,
    ...
    override fun onBindViewHolder(holder: CartAdapter.ViewHolder, position: Int) {
        ...
        "$${item.Price}".also { holder.binding.totalTxt.text = it }
        "$${item.numberInCart * item.Price.toDouble()}".also { holder.binding.totalEachPrice.text = it }
